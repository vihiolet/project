	...
	<body>
    	...
    	<%if(articleList != null && listCount > 0){%>
            ...
            <tr class="keyword_info">            	
                ...
                <td><input type="text" name="" id= "srch_name" class= "" size="15" value="<%=articleList.get(i).getPro_company() %>"></td>
                <td><input type="text" name="" id= "create_id" class= "pro_tit" size="15" value="<%=articleList.get(i).getPro_nm() %>"></td>
