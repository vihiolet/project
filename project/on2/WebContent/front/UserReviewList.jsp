          	...
          	<div>
                 <table class="review_list">
	                 <tr class="keyword_tit">
			                <td><input type="checkbox" id= "allcheck" class= "review_code" onClick='allCheck()'></td>                
			          ...
			          <c:forEach var= "myReview" items= "${myReview}" varStatus="status"> 
		                ...
		                <td><input type="checkbox" class= "review_code" value="${myReview.review_code}"></td>               
		                <td class="photo">
...
<script>
	//다중 체크
	function allCheck(){
		let ac= document.getElementsById('allcheck');
